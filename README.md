...
5. **Logo.** The navbar/footer currently use a small drawn CSS mark as a placeholder logo. Swap `.brand-mark` for an `<img>` referencing `assets/logo/your-logo.svg` if you have a real mark.
